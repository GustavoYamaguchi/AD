...
Queremos verificar agora se com teste de hipótese podemos conlcuir se existe diferenca entre a popularidade de java para os seguintes dias: terca e quinta.
...
No grafico acima vemos dois tracos laranjas, esse valor é de +-96, que eh a diferenca das medianas de modificacoes em arquivos java na terca e quinta feira na nossa amostra do github; valores maiores que essa diferenca (em modulo), sao as permutacoes que negam nossa hipotese nula.
